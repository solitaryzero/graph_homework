...
def main():
    ...
    config = AutoConfig.from_pretrained(args.model_name_or_path, num_labels=40)
    ...
    def preprocess_function(examples):
        ...
        inputs = [t+a for t, a in zip(titles, abstracts)]
    ...
    with accelerator.main_process_first():
        processed_datasets = raw_datasets.map(
            ...
            remove_columns=["title", "abstract", "label"],
    ...
    if args.with_tracking:
        ...
        accelerator.init_trackers(project_name="graph", config=experiment_config, init_kwargs={"wandb": {"name": "chid_"+args.output_dir.split("/")[-1]}})
